<h2 align="center"><b><i>hello-rails-backend</i></b></h2>
...
- [Node.js and npm](https://nodejs.org/)/yarn
...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone git@https://github.com/the-faizmohammad/Sample-React-Backend
